...
standard second-based deadlines and the contract works on any EVM chain. Proved
on-chain: `createBounty` + `submitCommitment` with second-based deadlines succeed
(`0x5227baff...`, `0x25b34ee8...`). Covered by `RitualMsTimestampTest`.
