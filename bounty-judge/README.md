...
> encrypted TEE submissions and on-chain attestation. 77+ tests, all passing.
...
**77 tests, 0 failed, 0 skipped** (verified with `forge test -vvv`):
...
| RitualTeeIntegrationTest (Track 2 TEE) | 3 | 3 ✅ |
...
| `test/BountyJudge.t.sol` | Both | 77 test cases (53 + 22 + 2), all passing |
