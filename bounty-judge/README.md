...
> encrypted TEE submissions and on-chain attestation. 73+ tests, all passing.
...
**73 tests, 0 failed, 0 skipped** (verified with `forge test -vvv`):

| Suite | Tests | Passed |
|-------|-------|--------|
| BountyJudgeTest (Track 1) | 46 | 46 ✅ |
| BountyJudgeFuzzTest (fuzz + invariant) | 4 | 4 ✅ |
| RitualBountyJudgeTest (Track 2) | 15 | 15 ✅ |
| RitualBountyJudgeFuzzTest (Track 2 fuzz) | 4 | 4 ✅ |
| RitualTeeIntegrationTest (Track 2 TEE) | 2 | 2 ✅ |
...
| `test/BountyJudge.t.sol` | Both | 73 test cases (50 + 21 + 2), all passing |
